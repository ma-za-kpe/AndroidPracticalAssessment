...
if [ $# -eq 0 ]; then
    jar_file_path="../androidassessmentamalitech-tools/checkstyle-8.37-all.jar"
else
    jar_file_path="$github_actions_path/androidassessmentamalitech-tools/checkstyle-8.37-all.jar"
fi
